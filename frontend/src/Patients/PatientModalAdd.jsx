  ...
  return (
    <div>
      <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        <Box component="form" sx={modalStyle} noValidate autoComplete="off" onSubmit={handleSubmit}>
					...
					<Grid container spacing={2}>
						...
						<Grid item xs={12} sm={2}>
							<TextField fullWidth required id="outlined-required" label="Retorno" name="return_patient" value={patient.return_patient} onChange={handleInputChange} variant="outlined"/>
						</Grid>
						<Grid item xs={12} sm={2}>
            	...
            	<TextField fullWidth id="outlined-multiline-static" label="Descrição do Problema" value={patient.description_problem} name="description_problem" onChange={handleInputChange} multiline rows={10} variant="outlined"/>
						...
						<Grid item xs={12} container justifyContent="center">
							<Button variant="contained" color="primary" sx={{ width: "20%" }} type="submit" onClick={() => addPatient}>
								Salvar
							</Button>
							<Button variant="contained" onClick={handleClose} sx={{ backgroundColor: 'red', marginLeft: "20px", width: "20%" }} type="submit">
								Fechar
							</Button>
						</Grid>
					</Grid>
